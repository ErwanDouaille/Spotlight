...
*/
#define LG_ENV_HISTORIC_LENGTH_LONG 30
 ...
 * Default value.
*/
#define LG_ENV_HISTORIC_LENGTH_NORMAL 10
...
*/
#define LG_ENV_HISTORIC_LENGTH_SHORT 3
...
namespace lg
{
	// Forward declaration of some type -> Environment will be fully declared
	class Node;
...
#if !defined _WIN32  && !defined _WIN64
	int getHistoricLengthOfEnvironment(Environment* e){return e->getHistoricLength();}
#endif
